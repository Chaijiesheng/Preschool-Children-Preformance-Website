...
if (isset($_POST['submit'])) {
    ...
    echo "<script>setTimeout(\"location.href = '../subject2/tkd.php';\",100);</script>";
    exit();
}
                    ...
                    <form method="post">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">Level 1 <input class="form-check-input" type="checkbox" name="BM6[]" value="1"></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">Level 2 <input class="form-check-input" type="checkbox" name="BM6[]" value="2"></td>
                                <td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center">Level 3 <input class="form-check-input" type="checkbox" name="BM6[]" value="3"></td>
                                <td>
