...
if (isset($_POST['submit'])) {
    ...
    echo "<script>setTimeout(\"location.href = '../subject2/pi.php';\",100);</script>";
    exit();
}
            ...
            <div class="container-fluid">
                <div class="mt-2">
                    <div class="container">
                        <div class="row">
                            <div>
                                <h1 class="title">PENDIDIKAN ISLAM</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0 py-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">PENDIDIKAN ISLAM</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
