...
if (isset($_POST['submit'])) {
    ...
    $query = "insert into classa_pi(StudentId,StudentName,PI1,PI1_Date,PI1_Date2,PI1_Date3,PI2,PI2_Date,PI2_Date2,PI2_Date3,PI3,PI3_Date,PI3_Date2,PI3_Date3,PI4,PI4_Date,PI4_Date2,PI4_Date3,PI5,PI5_Date,PI5_Date2,PI5_Date3,class_code) 
    VALUES ('$StudentId','$StudentName','$BM1','$BM1_Date','$BM1_Date2','$BM1_Date3','$BM2','$BM2_Date','$BM2_Date2','$BM2_Date3','$BM3','$BM3_Date','$BM3_Date2','$BM3_Date3','$BM4','$BM4_Date','$BM4_Date2','$BM4_Date3','$BM5','$BM5_Date','$BM5_Date2','$BM5_Date3','$class_code')";
    ...
    echo "<script>setTimeout(\"location.href = '../subject2/bi.php';\",100);</script>";
    exit();
}
            ...
            <div class="container-fluid">
                <div class="mt-2">
                    <div class="container">
                        <div class="row">
                            <div>
                                <h1 class="title">Bahasa English</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0 py-2">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Bahasa English</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <table class="table table-bordered border-dark align-middle">
                    <form method="post">
                        ...
                        <thead class="table-dark">
                            <tr class="title">
                                <td colspan="5">Bahasa English</td>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center">Level 1 <input class="form-check-input" type="checkbox" name="BM4[]" value="1"></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="text-center">Level 2 <input class="form-check-input" type="checkbox" name="BM4[]" value="2"></td>
                                <td>
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center">Level 3 <input class="form-check-input" type="checkbox" name="BM4[]" value="3"></td>
                                <td>
                                    <div class="input-group date" id="datepicker8">
                            ...
                            <tr>
                                ...
                                <td>Listening and speaking skills</td>
                                <td class="text-center">Level 1 <input class="form-check-input" type="checkbox" name="BM5[]" value="1"></td>
                                <td>
                                    <div class="input-group date" id="datepicker9">
                            ...
                            <tr>
                                ...
                                <td class="text-center">Level 2 <input class="form-check-input" type="checkbox" name="BM5[]" value="2"></td>
                                <td>
                                    <div class="input-group date" id="datepicker10">
                            ...
                            <tr>
                                <td></td>
                                <td class="text-center">Level 3 <input class="form-check-input" type="checkbox" name="BM5[]" value="3"></td>
                                <td>
